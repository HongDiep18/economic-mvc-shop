...
<!-- Custom Css -->
<link rel="stylesheet" href="<?php echo PATH_URL; ?>admin/themes/plugins/bootstrap/css/bootstrap.min.css">
<link rel="stylesheet" href="<?php echo PATH_URL; ?>admin/themes/css/style.min.css">    
</head>
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-12">
                <form class="card auth_form" method="POST" role="form" action="index.php?controller=forgot-password&amp;action=request">
                    <div class="header">
                        <img class="logo" src="<?php echo PATH_URL; ?>admin/themes/images/logo.svg" alt="">
                        <h5>Quên mật khẩu ?</h5>
            ...
            <div class="col-lg-8 col-sm-12">
                <div class="card">
                    <img src="<?php echo PATH_URL; ?>admin/themes/images/signin.svg" alt="Forgot Password"/>
                </div>
            </div>
        </div>
    </div>
...
<!-- Jquery Core Js -->
<script src="<?php echo PATH_URL; ?>admin/themes/bundles/libscripts.bundle.js"></script>
<script src="<?php echo PATH_URL; ?>admin/themes/bundles/vendorscripts.bundle.js"></script> <!-- Lib Scripts Plugin Js --> 
</body>
</html>
